...
const Movies = () => {
    ...
    return <>
        ...
        {
            loading ? <img src="https://media1.giphy.com/media/xTkcEQACH24SMPxIQg/giphy.gif?cid=ecf05e47j6b5u0yf890dk1ln6jy9ldtwququaeeyo9r3synl&rid=giphy.gif&ct=g" alt="" style={{ width: "50vmax", marginLeft: "20vmax" }} /> : <div className='container mt-5 d-flex flex-wrap justify-content-center'>
                {datas.map((data, i) => (
